...
def dataframeSize(init_vars, aplist, usrlist):
    ...
    plot_from_saved = 1
    dataframe_size = np.arange(1, 40, 2)
    total_runs = range(20)
    _output = {}
    ...
    p = figure(width=1200, height=800, x_axis_label='Dataframe Size', y_axis_label='Total Number of Serviced Users', tooltips=TOOLTIPS, output_backend='svg')
